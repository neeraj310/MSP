...
%Average query Time is further divided by $K$ to compare the Query time across various values of $K$.
%As shown in the Fig. \ref{fig:KNN_Query_Comparision}, LISA outperforms $K$D-tree for different training sizes and $K$ values.
